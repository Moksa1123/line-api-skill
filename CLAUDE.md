...
| `checklists.csv` | 規範類頁面的條列規則 | ❌ 改 `tools/_checklists.py` |
| `liff-availability.csv` | `getContext()` 範例裡的 availability（LINE App 版本需求） | ❌ 改 `tools/_liff_extra.py` |
...
# 測試
python line-api/scripts/test_line.py            # 離線 55 項
