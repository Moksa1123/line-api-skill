...
| LIFF | 35개 API(모두 배포된 SDK에 실재함을 확인), 도입 LIFF 버전**과 각 기능이 요구하는 LINE 앱 버전**, 트리 셰이킹 모듈, 브라우저별 기능 대조표 |
| LINE MINI App | 추출된 1,196개 사양과 74개 심사·개발 규칙 —— 인증/미인증 기능 대조표, 서비스 메시지 제한, 인앱 결제, 커스텀 경로, 아이콘 규격 |
