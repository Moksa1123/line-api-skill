...
| LIFF | 35 API（すべて配信中の SDK に実在することを確認）、導入 LIFF バージョン**と各機能が必要とする LINE アプリのバージョン**、Tree-shaking 対応モジュール、ブラウザ別の機能対応表 |
| LINE MINI App | 抽出した 1,196 件の仕様と 74 件の審査・開発ルール —— 認証済み／未認証の機能対応表、サービスメッセージの上限、アプリ内課金、カスタムパス、アイコン仕様 |
